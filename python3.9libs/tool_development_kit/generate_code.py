...
class ActionType:
    ...
    def byKWARGS(**kwargs):
        return (
            kwargs["ctrlclick"] * ActionType.Internal
...
class GenerateCodeSettings(QDialog):
    def __init__(self, node, parent=None):
        ...
        self.recurse_toggle.setToolTip(
        ...
        self.save_channels_only_toggle.setToolTip(
        ...
        self.save_creation_commands_toggle.setToolTip(
            "Generate a creation script for the node. "
        ...
        self.save_keys_in_frames_toggle.setToolTip(
            "Output channel and key times in samples (frames) "
        ...
        self.save_parm_values_only_toggle.setToolTip(
            "Evaluate parameters, saving their values "
        ...
        self.save_spare_parms_toggle.setToolTip(
            "Save spare parameters as well. When save_creation_commands "
        ...
        self.function_name_field.setToolTip(
            "If a function_name is specified, the output will be wrapped "
